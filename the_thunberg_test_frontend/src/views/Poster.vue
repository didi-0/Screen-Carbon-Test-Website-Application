    ...
    <div class="container">
      <div class="little-title d-flex">
        ...
        <h2 class="text-center text-light">
          <i class="bi bi-three-dots-vertical"></i>Most Climate Friendly Films
          and TV Shows
        </h2>
      </div>
          ...
          <div v-for="(poster, index) in posterList" :key="index" class="col">
            <div class="card" style="height: 475px">
              ...
              <div class="card-body">
                ...
                <router-link
                  :to="'/film?id=' + poster.id + '&mediaType=movie'"
